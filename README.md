a crappy multi-valued dictionary [![Build Status](https://travis-ci.org/vonbecmann/multi-valued-dictionary.svg?branch=pharo6)](https://travis-ci.org/vonbecmann/multi-valued-dictionary)
